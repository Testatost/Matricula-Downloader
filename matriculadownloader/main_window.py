...
from PySide6.QtCore import QSettings, QStringListModel, Qt, QUrl, Signal, Slot
...
from matriculadownloader.app_constants import (
    APP_AUTHOR,
    APP_DISPLAY_NAME,
    APP_FONT,
    APP_GITHUB_URL,
...
from matriculadownloader.icons import get_app_icon, get_banner_pixmap
from matriculadownloader.i18n import LANG, LANGUAGE_LABELS, SUPPORTED_LANGS
from matriculadownloader.models import BookEntry
from matriculadownloader.styles import dark_stylesheet, light_stylesheet
from matriculadownloader.third_party import A4, HAVE_REPORTLAB, canvas
from matriculadownloader.worker import DownloaderWorker


class ShortcutLineEdit(QLineEdit):
    ctrlReturnPressed = Signal()
...
class MainWindow(QMainWindow):
    ...
    def _append_table_row(self, book: BookEntry) -> None:
        ...
        pages_item.setTextAlignment(int(Qt.AlignCenter))
