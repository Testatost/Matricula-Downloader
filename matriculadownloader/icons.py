...
from matriculadownloader.app_constants import APP_DISPLAY_NAME, APP_ID
...
def get_banner_pixmap(width: int = 680, height: int = 120) -> QPixmap:
    ...
    painter.drawText(30, height - 36, width - 60, 24, int(Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter), "Matricula • GUI Downloader")
